...
- https://ckeditor.com/docs/ or https://ckeditor.com/docs/ckeditor5/
- https://jwt.io/
- https://ckeditor.com/docs/ckeditor5/latest/framework/tutorials/crash-course/model-and-schema.html
- https://ckeditor.com/docs/ckeditor5/latest/framework/deep-dive/conversion/intro.html
...
- Go to <https://portal.ckeditor.com/signup?utm_campaign=devrel_ghw_hackathon_aug_2025&utm_source=mlh&utm_medium=referral&utm_term=challenges>
- Fill in the form with your details
- Walkthrough the portal
  ...
  - More important
    - Overview
      - **Quick start** - important to challenges
      - Overview - Features
      - **License keys**
        - **Trial license key**
          - Mention JWT.io
...
- Walkthrough the types of CKEditor (with preview)
- [Optional] Switch to demos
- Select Classic (starter)
- Describe the Basic vs. Advanced view
- Select a couple of plugins (Emoji, Mention, Command) => example Autoformat
- Show "Start over"
- Show features - describe the options
...
- `git init`
- Add `.gitignore` file and let the AI generate the first version
- `git add .`
- `git commit -m "Initial commit"`

## Typescript (and other dev stuff)

- `npm i -g typescript` - install TypeScript globally and provide the `tsc` command
- `tsc --init`
- Rename `main.js` to `main.ts` + `vite.config.js` to `vite.config.ts`
- Change the link in `index.html` to `main.ts`
- Adjust the main.ts
...
### Configure the mention plugin with static set of users
...
> If not done in the first workshop
...
## Adding (premium) feature - form the builder

- Open the configuration based on the link at the beginning
- Add the "Template" plugin
- Show the snippets
  - `npm install ckeditor5-premium-features`
  - Add the adjustments one by one
...
- Configure the image toolbar options
...
- Mention that toolbar and upload image is possible, bit this is not a use case
